...
class Integration implements \FRFreeVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    public function hooks()
    {
        ...
        $my_account = new \FRFreeVendor\WPDesk\Library\FlexibleRefundsCore\Integration\MyAccount($renderer, $settings, $ajax);
        if (self::is_super()) {
            $this->add_hookable(new \FRFreeVendor\WPDesk\Library\FlexibleRefundsCore\Integration\PublicRefundShortcode($renderer, $my_account));
        }
